...
- `第二级样本`
  - 条件：`第一级样本` 且 `n_core_vars_available >= 2`
  - 用途：增强模型样本

- `第三级样本`
  - 条件：`第一级样本` 且 `n_core_vars_available >= 3`
  - 用途：高信息验证模型样本
